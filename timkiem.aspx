<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="timkiem.aspx.cs" Inherits="Default2" Title="Untitled Page" %>
                ...
                <tr>
                    <td style="width: 205px; height: 18px; text-align: center" valign="top">
                        <asp:Label ID="Label10" runat="server" Font-Size="Smaller" Text="Đã đưa vào giỏ hàng"
                            Visible="False" Width="111px" style="color: #FF3300; font-size: small"></asp:Label>
                    </td>
                </tr>
            </table>
        </ItemTemplate>
